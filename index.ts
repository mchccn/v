const esc = (string: string) => string.replace(/[|\\{}()[\]^$+*?.]/g, "\\$&").replace(/-/g, "\\x2d");

export default class V4gu3 {
    constructor() {
        throw new Error("Class V4gu3 cannot be instantiated.");
    }

    static r3m0veNumb3rs(string: string) {
    ...
    static r3m0veSymb0ls(string: string) {
    ...
    static r3m0veUn1c0de(string: string) {
    ...
    static f1nd(string: string, search: string, opts: Parameters<typeof V4gu3.f1lt3r>[1]) {
